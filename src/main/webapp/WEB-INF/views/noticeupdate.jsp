...
<body>
	...
	<form action="noticeupdateOk" method="post"  enctype="multipart/form-data">
		...
		<table class="table table-striped table-bordered">
			...
			<tr>
				<td  colspan="4" align="right" style="border: none;">
						...
						<input type="button" class="btn btn-secondary" value="목록" onclick="post_to_url('notice', {'p':'${p}','s':'${s}','b':'${b}'});">
				</td>  
			</tr>
		</table>	
		</div>
