...
<title>${dname}인사고과 평가작성</title>
</head>
<body>
<div align="center" id="list" style="padding-bottom: 25px;">
      <b>${dname}부서 ${name_v}님의 인사 평가</b>
    </div>
	<form  name="formName" action="evaluationSave"  id="formName" method="post" onsubmit="return formCheck();">
            ...
            <tr>
          	...
          	<tr>
				<td  colspan="4" align="right" style="border: none;">
							<input type="submit" class="btn btn-primary" value="임시저장"  >
							<input type="button"  class="btn btn-danger" value="최종제출" onclick="post_to_url('evaluationFinalInput', {'duty':'${duty }','lev':'${lev }','dname':'${dname }','name_p':'${name_p }','name_v':'${name_v }','Id_emp_p':'${Id_emp_p }','Id_emp_v':'${Id_emp_v }','duty_d':'${duty_d }','lev_l':'${lev_l }'});">
