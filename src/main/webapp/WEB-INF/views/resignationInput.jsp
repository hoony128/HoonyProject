...
<div align="center" id="list" style="padding-bottom: 25px;">
	...
	<form  name="formName" action="resignationSave"  id="formName" method="post" onsubmit="return formCheck();">
            ...
            <tr>
          	...
          	<tr>
				<td  colspan="4" align="right" style="border: none;">
							...
							<input type="button"  class="btn btn-danger" value="퇴사요청" onclick="post_to_url('resignationFinalInput', {'duty':'${duty }','lev':'${lev }','dname':'${dname }','name_p':'${name_p }','name_v':'${name_v }','Id_emp_p':'${Id_emp_p }','Id_emp_v':'${Id_emp_v }','duty_d':'${duty_d }','lev_l':'${lev_l }'});">
