...
public class EvaluationVO {
	...
	public String toString() {
		return "EvaluationVO [idx=" + idx + ", Id_emp_p=" + Id_emp_p + ", name_p=" + name_p + ", score=" + score
				+ ", reason=" + reason + ", Id_emp_v=" + Id_emp_v + ", name_v=" + name_v + ", savedate=" + savedate
				+ ", dname=" + dname + ", duty_d=" + duty_d + ", lev_l=" + lev_l + ", duty=" + duty + ", lev=" + lev
				+ "]";
	}
